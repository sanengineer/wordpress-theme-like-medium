			...
			<div class="single-ads" id="singleAds">
                <div class="single-ads-title">
                    ...
                    <div class="single-ads-script">
						<div class="example-ads" style="height:300px;background-size: cover;background-repeat: no-repeat;background-image:url('https://sanengineer.com/wp-content/uploads/2020/04/ads-dummy-rectangle.jpg')"></div> <!-- delete this line after fiil adsense code -->
                    	<!-- <?php if($adsense == 1){
