            ...
            <main id="main" class="site-main" role="main">
                ...
                <div class="single-ads" id="singleAds">
                    ...
                    <div class="single-ads-script">
                        <div class="example-ads"
                            style="height:300px;background-size: cover;background-repeat: no-repeat;background-image:url('https://sanengineer.com/wp-content/uploads/2020/04/ads-dummy-rectangle.jpg')">
                        </div> <!-- delete this line after fiil adsense code -->
                        <!-- <?php if($adsense == 1){
                ...
                <div class="promo-content alert alert-warning alert-dismissible fade show" role="alert">
                    <div class="promo-text">
                        ...
                        <p>Aliquet risus feugiat in ante metus dictum. Nunc faucibus a pellentesque sit amet porttitor.
                            Risus sed vulputate odio ut enim. Amet porttitor eget dolor morbi. Bibendum arcu vitae
                    ...
                    <div class="link-web">
                        <a class="btn btn-warning link-external-web" href="#" target="_blank"
                            rel="noopener noreffer nofolow">visit external link</a>
